...
const WritePostModal = ({ isOpen, onClose, onSubmit, user }) => {
    ...
    const [rating, setRating] = useState('positive'); // positive, neutral, negative
    const [isSubmitting, setIsSubmitting] = useState(false);

    const ratings = [
        { value: 'positive', icon: Smile, label: 'Positive', color: 'text-emerald-400' },
        { value: 'neutral', icon: Meh, label: 'Neutral', color: 'text-amber-400' },
        { value: 'negative', icon: Frown, label: 'Critical', color: 'text-rose-400' }
    ];
                    ...
                    >
                                    ...
                                    {ratings.map((r) => {
                                        ...
                                        return (
                                            <button
                                                ...
                                                `}
                                            >
                                                <Icon className={`w-6 h-6 ${isSelected ? r.color : 'text-white/40'}`} />
                        ...
                        <div className="px-6 pb-6">
                            <div className="flex items-center gap-3 p-3 bg-white/5 rounded-xl">
                                ...
                                <div>
                                    <p className="text-sm text-white font-medium">{user?.name || 'Anonymous'}</p>
